# This code is to build a Buffered region for Power Cables
...
input_folder_name = "raw_Powercables_shp"
...
shapefile_path = os.path.join(input_folder_path, "pcablesshomLine.shp")
...
output_folder_name = "buffer_Powercables_shp"
